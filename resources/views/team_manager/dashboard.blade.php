@extends('team_manager/layout/master')
@section('content')
                        ...
                        <!-- <div class="col-span-12 xl:col-span-4 mt-6">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                            <img alt="Midone Tailwind HTML Admin Template" src="{{asset('assets')}}/dist/images/profile-13.jpg">
                                        </div>
                                        <div class="ml-4 mr-auto">
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                            <img alt="Midone Tailwind HTML Admin Template" src="{{asset('assets')}}/dist/images/profile-11.jpg">
                                        </div>
                                        <div class="ml-4 mr-auto">
                                    ...
                                    <tbody>
                                            ...
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-2.jpg" title="Uploaded at 23 March 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-14.jpg" title="Uploaded at 14 September 2020">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-14.jpg" title="Uploaded at 7 May 2022">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-5.jpg" title="Uploaded at 20 June 2020">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-9.jpg" title="Uploaded at 1 August 2020">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-10.jpg" title="Uploaded at 5 January 2022">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-12.jpg" title="Uploaded at 27 June 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-10.jpg" title="Uploaded at 15 August 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-10.jpg" title="Uploaded at 13 May 2022">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-5.jpg" title="Uploaded at 20 April 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-8.jpg" title="Uploaded at 26 May 2020">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{asset('assets')}}/dist/images/preview-10.jpg" title="Uploaded at 9 September 2022">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                            ...
                            <!-- <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3 xxl:mt-8">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                <img alt="Midone Tailwind HTML Admin Template" src="{{asset('assets')}}/dist/images/profile-7.jpg">
                                            </div>
                                            <div class="ml-4 mr-auto">
                                ...
                                <div class="report-timeline mt-5 relative">
                                    <div class="intro-x relative flex items-center mb-3">
                                        <div class="report-timeline__image">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                <img alt="Midone Tailwind HTML Admin Template" src="{{asset('assets')}}/dist/images/profile-3.jpg">
                                            </div>
                                        </div>
                                            ...
                                            <div class="text-gray-600">
                                                ...
                                                <div class="flex mt-2">
                                                    <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{asset('assets')}}/dist/images/preview-10.jpg">
                                                    </div>
                                                    ...
                                                    <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nikon Z6">
                                                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{asset('/assets')}}/dist/images/preview-3.jpg">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
